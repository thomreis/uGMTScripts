...
printf "\x1f\x8b\x08\x00\x00\x00\x00\x00" | cat - /home/utcausr/test_patterns/JPsiToMuMu_Pt20to120_EtaPhiRestricted/rx_JPsiToMuMu_Pt20to120_EtaPhiRestricted_2.zip | gzip -dc > $tmp_path/uncompressed.txt
...
mp7butler.py -c $CONN -v xbuffers $address --timeout $TIMEOUT tx PlayOnce -e $e --inject file://$tmp_path/uncompressed.txt 
...
mp7butler.py -c $CONN easylatency $address --timeout $TIMEOUT --txBank 2 --tx 0-23,24-31 --rxBank 1 --rx 36-71 --algoLatency 27 --masterLatency 37 --rxExtraFrames 12 --txExtraFrames 12
#mp7butler.py -c $CONN easylatency $address --timeout $TIMEOUT --txBank 2 --tx 0-71 --rxBank 1 --rx 0-71 --algoLatency 27 --masterLatency 37 --rxExtraFrames 12 --txExtraFrames 12
#mp7butler.py -c $CONN easylatency $address --timeout $TIMEOUT --txBank 2 --tx 1 --rxBank 1 --rx 0-3 --algoLatency 27 --masterLatency 37 --rxExtraFrames 12 --txExtraFrames 12
#mp7butler.py -c $CONN easylatency $address --timeout $TIMEOUT --txBank 2 --tx 31 --rxBank 1 --rx 50 --algoLatency 27 --masterLatency 37 --rxExtraFrames 12 --txExtraFrames 12
mp7butler.py -c $CONN rosetup $address --timeout $TIMEOUT --internal --bxoffset 2
#mp7butler.py -c $CONN rosetup $address --bxoffset 2
mp7butler.py -c $CONN romenu $address --timeout $TIMEOUT $ROMENU_FILE standardMenu
mp7butler.py -c $CONN zsmenu $address --timeout $TIMEOUT $ROMENU_FILE zsStandardMenu # comment this line if the ZS is configured with SWATCH
#bash setup_zs.sh
...
do
  ...
  mp7butler.py -c $CONN write $address --timeout $TIMEOUT readout.readout_zs.csr.ctrl.en 0 &>/dev/null
  mp7butler.py -c $CONN -v roevents $address --timeout $TIMEOUT 1 --bxs $i --outputpath $tmp_path/output_nozs.dat &> $tmp_path/roevents_nozs.txt
  ...
  mp7butler.py -c $CONN write $address --timeout $TIMEOUT readout.readout_zs.csr.ctrl.en 1 &>/dev/null
  mp7butler.py -c $CONN -v roevents $address --timeout $TIMEOUT 1 --bxs $i --outputpath $tmp_path/output_zs.dat &> $tmp_path/roevents_zs.txt
