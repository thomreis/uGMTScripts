...
mp7butler.py -c $CONN romenu $address $root_path/../mp7_test/ugmt_ro_zs_menu.py standardMenu
mp7butler.py -c $CONN zsmenu $address $root_path/../mp7_test/ugmt_ro_zs_menu.py zsStandardMenu
