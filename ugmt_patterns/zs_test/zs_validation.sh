...
do
  ...
  mp7butler.py -c $CONN -v xbuffers $address tx PlayOnce -e $e --timeout $TIMEOUT --inject file://$tmp_path/uncompressed.txt
  ...
  do
    ...
    mp7butler.py -c $CONN -v roevents $address 1 --bxs $i --timeout $TIMEOUT --outputpath $tmp_path/output_nozs.dat &> $tmp_path/roevents_nozs.txt
    ...
    mp7butler.py -c $CONN -v roevents $address 1 --bxs $i --timeout $TIMEOUT --outputpath $tmp_path/output_zs.dat &> $tmp_path/roevents_zs.txt
